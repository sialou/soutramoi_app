...
import { AsyncSubject, Subscription, Subject, fromEvent, lastValueFrom, merge } from 'rxjs';
import { first, filter, debounceTime, tap, switchMap, takeUntil, take, startWith, mapTo } from 'rxjs/operators';
...
class MapService {
    ...
    setup(options) {
        ...
        this.zone.onStable.pipe(first()).subscribe(() => {
            ...
            this.createMap(Object.assign(Object.assign({}, options.mapOptions), { accessToken: options.accessToken || this.MAPBOX_API_KEY || '' }));
    ...
    move(movingMethod, movingOptions, zoom, center, bearing, pitch) {
        return this.zone.runOutsideAngular(() => {
            this.mapInstance[movingMethod](Object.assign(Object.assign({}, movingOptions), { zoom: zoom != null ? zoom : this.mapInstance.getZoom(), center: center != null ? center : this.mapInstance.getCenter(), bearing: bearing != null ? bearing : this.mapInstance.getBearing(), pitch: pitch != null ? pitch : this.mapInstance.getPitch() }));
        });
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.1.1", ngImport: i0, type: AttributionControlDirective, decorators: [{
        ...
        return [{ type: MapService }, { type: ControlComponent, decorators: [{
                        type: Host
                    }] }];
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.1.1", ngImport: i0, type: FeatureComponent, decorators: [{
        ...
        return [{ type: GeoJSONSourceComponent, decorators: [{
                        type: Inject,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.1.1", ngImport: i0, type: DraggableDirective, decorators: [{
        ...
        return [{ type: MapService }, { type: i0.NgZone }, { type: FeatureComponent, decorators: [{
                        type: Optional
                    }, {
                        type: Host
                    }] }];
